...
bs_all <- function(i){  
  ...
  urls_is <- paste0("https://www.investing.com", links2, "-balance-sheet")
  is_list_brazil <- list()
  ...
  is_lapply <- function(ll){  
    ...
    firm_link <- paste0("https://www.investing.com", ll, "-balance-sheet")
  ...
  path_ch <- paste0(countries$country[i],"_bs.csv")
