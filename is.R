...
# countries data set provided at another r script
...
urls_is <- paste0("https://www.investing.com", links2, "-income-statement")
is_list_brazil <- list()
...
firm_link <- paste0("https://www.investing.com", ll, "-income-statement")
...
path_ch <- paste0(countries$country[i],"_is.csv")
